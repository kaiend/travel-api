...
class WxorderValidator
{
	...
	{
		$only = ['user_id','type','price','origin','end','car_series','orders_name','orders_phone','appointment','passenger_name','passenger_phone','cip','origin_position','end_position','city','remarks','custom','passenger_people'];
